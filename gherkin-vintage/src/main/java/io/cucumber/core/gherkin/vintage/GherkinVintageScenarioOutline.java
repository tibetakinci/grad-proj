...
final class GherkinVintageScenarioOutline implements ScenarioOutline {
    ...
    GherkinVintageScenarioOutline(gherkin.ast.ScenarioOutline scenarioOutline) {
        ...
        this.children = scenarioOutline.getExamples().stream().map(GherkinVintageExamples::new).collect(Collectors.toList());
    }

    @Override
    public Collection<Examples> children() { return children; }
